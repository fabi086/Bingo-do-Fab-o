...
const Auth: React.FC<AuthProps> = ({ onLoginSuccess, allUsers }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white p-4 flex items-center justify-center bg-[radial-gradient(circle_at_top_left,_rgba(30,_58,_138,_0.4),_transparent_30%),_radial-gradient(circle_at_bottom_right,_rgba(17,_24,_39,_0.3),_transparent_40%)]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
            <h1 className="text-5xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-500">Bingo do Fabão</h1>
        ...
        <InfoCard icon={isLoginView ? '🔑' : '👤'} title={isLoginView ? 'Login' : 'Cadastro'}>
          <form onSubmit={isLoginView ? handleLogin : handleRegister} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white font-bold py-3 rounded-lg text-lg transition-all"
            >
          ...
          <button
            ...
            className="w-full mt-4 text-sky-300 hover:underline"
          >
